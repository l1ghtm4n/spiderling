...
page.settings.userAgent = "Mozilla/5.0 (platform; rv:geckoversion) Gecko/geckotrail Firefox/firefoxversion";
page.settings.loadImages = false;
page.settings.resourceTimeout = 6000; //in milliseconds
